...
Write-Host "Iniciando configuracion segura de Skill Voz e IA..." -ForegroundColor Cyan
...
Write-Host "Skill Voz e inteligencia Groq quedaron desplegadas para el proyecto." -ForegroundColor Green
