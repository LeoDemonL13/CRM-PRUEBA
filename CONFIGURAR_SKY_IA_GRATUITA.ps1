...
Invoke-Supabase @("secrets","set","SKY_GROQ_INTENT_MODEL=openai/gpt-oss-20b","SKY_GROQ_CHAT_FAST_MODEL=openai/gpt-oss-20b","SKY_GROQ_CHAT_MODEL=openai/gpt-oss-120b","SKY_GEMINI_INTENT_MODEL=gemini-3.5-flash-lite","SKY_GEMINI_CHAT_FAST_MODEL=gemini-3.5-flash-lite","SKY_GEMINI_CHAT_MODEL=gemini-3.6-flash","SKY_OPENROUTER_MODEL=openrouter/free","SKY_AI_PROVIDER_ORDER=groq,gemini,openrouter","SKY_ALLOW_FREE_FALLBACK_WITH_INTERNAL_DATA=false","--project-ref",$projectRef)
