(function () {
    ...
    function ensureMobileSidebarTrigger() {
        ...
        button.addEventListener('click', () => {const opening=!document.body.classList.contains('skilled-mobile-sidebar-open');document.body.classList.toggle('skilled-mobile-sidebar-open',opening);button.setAttribute('aria-expanded',opening?'true':'false');if(opening){const scroll=document.querySelector('#skilled-sidebar .lista-scroll');if(scroll)scroll.scrollTop=0;}});
...
`;
    ...
    function ensureMobileDock() {
        ...
        if (!dock) {
            ...
            menu.addEventListener('click', () => {document.body.classList.add('skilled-mobile-sidebar-open');const scroll=document.querySelector('#skilled-sidebar .lista-scroll');if(scroll)scroll.scrollTop=0;});
