(function () {
    ...
    const profileSections={
        compras:[
            ...
            {title:'Compras generales',items:[['CO.tienda.html','Tienda','box'],['CO.servicios.html','Servicios','clipboard']]},
    ...
    function addSharedStyles() {
        if (document.getElementById('skilled-shared-ui-v12136')) return;
        const style = document.createElement('style');
        style.id = 'skilled-shared-ui-v12136';
        style.textContent = `
