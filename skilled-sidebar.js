(function () {
    ...
    function sidebarStorageKey(role = currentRole()) {
        return `skilled_sidebar_compact_v78_${sidebarProfileKey(role)}`;
    }
    ...
    function sectionsForRole(){const role=currentRole();const profile=sidebarProfileKey(role);if(role==='administrador'){const base=(profile==='almacen'?warehouseSections:(profileSections[profile]||warehouseSections)).map(section=>({title:section.title,items:[...section.items]}));base.push({title:'Administración',items:[['ADM.importaciones.html','Centro de importaciones','delivery'],['ADM.limpieza.html','Limpieza de pruebas','server']]});return base}return ['jefe_almacen','almacen'].includes(role)?warehouseSections:(profileSections[profile]||profileSections[role]||profileSections.consulta)}
    ...
    function renderSidebar() {
        ...
        renderedRole = role;
        aside.className = 'skilled-sidebar skilled-sidebar-shell h-screen sticky top-0 bg-[#090d1a] border-r border-[#161f38] flex flex-col justify-between shrink-0';
        aside.innerHTML = `
    ...
    function ensureMobileSidebarTrigger() {
        ...
        button.addEventListener('click', () => setMobileSidebarOpen(!document.body.classList.contains('skilled-mobile-sidebar-open')));
    ...
    function addSharedStyles() {
        if (document.getElementById('skilled-shared-ui-v139')) return;
        const style = document.createElement('style');
        style.id = 'skilled-shared-ui-v139';
        style.textContent = `
            ...
            #skilled-sidebar{width:260px;min-width:260px;flex-basis:260px;transition:width .2s ease,min-width .2s ease,flex-basis .2s ease,transform .22s ease;z-index:40}@media(min-width:1024px){body:not(.login-dark):not(.crm-v83-no-sidebar).skilled-has-sidebar{padding-left:260px!important;transition:padding-left .2s ease}body:not(.login-dark):not(.crm-v83-no-sidebar).skilled-has-sidebar.skilled-sidebar-collapsed{padding-left:76px!important}#skilled-sidebar{position:fixed!important;left:0;top:0;bottom:0;height:100dvh!important;max-height:100dvh!important;z-index:70!important}#skilled-sidebar .lista-scroll{overflow-y:auto!important;overscroll-behavior:contain}body>div.flex-1>header{position:sticky!important;top:0!important;z-index:60!important}}.skilled-sidebar-brand{padding:18px 16px;min-height:72px}.skilled-sidebar-logo-link{min-width:0;display:flex;align-items:center}.skilled-sidebar-logo{max-width:150px;transition:max-width .18s ease,height .18s ease}.skilled-sidebar-collapse,.skilled-mobile-sidebar-toggle{width:36px;height:36px;display:inline-flex;align-items:center;justify-content:center;border:1px solid #243257;border-radius:10px;color:#8190aa;background:#0c1324;transition:.16s;flex:0 0 auto}.skilled-sidebar-collapse:hover,.skilled-mobile-sidebar-toggle:hover{color:#fff;background:#141d34;border-color:#365386}.skilled-sidebar-collapse svg,.skilled-mobile-sidebar-toggle svg{width:18px;height:18px;fill:none;stroke:currentColor;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}.skilled-mobile-sidebar-toggle{display:none;margin-right:10px}.skilled-sidebar-shell nav{transition:padding .18s ease}.skilled-sidebar-shell [data-sidebar-link]{min-height:40px;white-space:nowrap}.skilled-sidebar-shell .skilled-sidebar-label,.skilled-sidebar-section-title{transition:opacity .12s ease}.skilled-sidebar-shell svg{flex:0 0 auto}.skilled-sidebar-shell .lista-scroll{overscroll-behavior:contain}.skilled-sidebar-logout{min-height:42px}#skilled-sidebar-overlay{display:none;position:fixed;inset:0;z-index:180;border:0;background:rgba(2,5,14,.68);backdrop-filter:blur(2px)}body.skilled-sidebar-collapsed #skilled-sidebar{width:76px;min-width:76px;flex-basis:76px;overflow-x:hidden}body.skilled-sidebar-collapsed .skilled-sidebar-brand{padding:18px 10px;justify-content:center;flex-direction:column;gap:8px}body.skilled-sidebar-collapsed .skilled-sidebar-logo{height:25px;max-width:52px;object-fit:contain}body.skilled-sidebar-collapsed #skilled-sidebar nav{padding-left:10px!important;padding-right:10px!important}body.skilled-sidebar-collapsed .skilled-sidebar-section-title,body.skilled-sidebar-collapsed .skilled-sidebar-label{display:none}body.skilled-sidebar-collapsed #skilled-sidebar nav>div{margin-top:0!important}body.skilled-sidebar-collapsed #skilled-sidebar nav>div+div{margin-top:12px!important;padding-top:12px;border-top:1px solid #161f38}body.skilled-sidebar-collapsed #skilled-sidebar [data-sidebar-link]{justify-content:center;gap:0;padding-left:0!important;padding-right:0!important;overflow:hidden}body.skilled-sidebar-collapsed #skilled-sidebar [data-sidebar-link]>span:not([data-request-badge]),body.skilled-sidebar-collapsed #skilled-sidebar [data-sidebar-link]>.skilled-sidebar-label{display:none!important}body.skilled-sidebar-collapsed #skilled-sidebar [data-sidebar-link] svg{width:19px;height:19px}body.skilled-sidebar-collapsed .skilled-sidebar-collapse svg{transform:rotate(180deg)}body.skilled-sidebar-collapsed #skilled-sidebar>div:last-child{padding:10px!important}body.skilled-sidebar-collapsed .skilled-sidebar-logout{padding-left:0!important;padding-right:0!important}body.tema-claro .skilled-sidebar-collapse,body.tema-claro .skilled-mobile-sidebar-toggle{background:#f3f6fb;border-color:#d7e0ec;color:#5d687b}body.tema-claro .skilled-sidebar-collapse:hover,body.tema-claro .skilled-mobile-sidebar-toggle:hover{background:#e8edf5;color:#111827}@media(max-width:1023px){body{padding-left:0!important}header.skilled-app-header{position:sticky!important;top:0!important;z-index:230!important}#skilled-sidebar{display:flex!important;position:fixed!important;left:0;top:var(--skilled-mobile-sidebar-top,56px)!important;bottom:0!important;height:auto!important;max-height:calc(100dvh - var(--skilled-mobile-sidebar-top,56px))!important;min-height:0!important;width:min(332px,calc(100vw - 48px))!important;min-width:0!important;flex-basis:auto!important;max-width:332px;z-index:190;transform:translateX(-105%);box-shadow:24px 0 65px rgba(0,0,0,.58);border-right-color:#263654!important;overflow:hidden!important}#skilled-sidebar-overlay{top:var(--skilled-mobile-sidebar-top,56px)!important;bottom:0!important;height:auto!important}#skilled-sidebar .lista-scroll{min-height:0!important;overflow-y:auto!important;overscroll-behavior:contain!important;-webkit-overflow-scrolling:touch}.skilled-sidebar-brand{position:sticky!important;top:0!important;z-index:4!important;background:linear-gradient(180deg,#0c1426,#090d1a)!important}body.tema-claro .skilled-sidebar-brand{background:linear-gradient(180deg,#ffffff,#f7f9fc)!important}.skilled-sidebar-brand{padding:12px 14px!important;min-height:64px!important;justify-content:space-between!important;flex-direction:row!important;gap:10px!important}.skilled-sidebar-logo{height:36px!important;max-width:150px!important;object-fit:contain!important}.skilled-sidebar-logo-link{max-width:calc(100% - 48px)!important;overflow:hidden!important}body.skilled-mobile-sidebar-open #skilled-sidebar{transform:translateX(0)}body.skilled-mobile-sidebar-open{overflow:hidden!important}body.skilled-mobile-sidebar-open #skilled-sidebar-overlay{display:block}.skilled-sidebar-collapse svg{transform:rotate(180deg)}.skilled-mobile-sidebar-toggle{display:inline-flex}body.skilled-sidebar-collapsed #skilled-sidebar{width:min(332px,calc(100vw - 48px))!important}body.skilled-sidebar-collapsed .skilled-sidebar-brand{padding:12px 14px;min-height:64px;justify-content:space-between;flex-direction:row;background:linear-gradient(180deg,#0c1426,#090d1a)}body.skilled-sidebar-collapsed .skilled-sidebar-logo{height:36px;max-width:150px}body.skilled-sidebar-collapsed #skilled-sidebar nav{padding:12px 12px 18px!important}.skilled-sidebar-shell .lista-scroll{scrollbar-width:thin}.skilled-sidebar-shell nav>div+div{margin-top:18px!important}.skilled-sidebar-shell [data-sidebar-link]{min-height:42px;border-radius:10px}.skilled-sidebar-section-title{font-size:9px!important;letter-spacing:.12em!important;color:#697892!important}body.skilled-sidebar-collapsed .skilled-sidebar-section-title,body.skilled-sidebar-collapsed .skilled-sidebar-label{display:inline}body.skilled-sidebar-collapsed #skilled-sidebar nav>div+div{margin-top:24px!important;padding-top:0;border-top:0}body.skilled-sidebar-collapsed #skilled-sidebar [data-sidebar-link]{justify-content:flex-start;gap:12px;padding-left:12px!important;padding-right:12px!important}body.skilled-sidebar-collapsed #skilled-sidebar>div:last-child{padding:16px!important}body.skilled-sidebar-collapsed .skilled-sidebar-logout{padding-left:12px!important;padding-right:12px!important}header{padding-left:12px!important;padding-right:12px!important}.skilled-global-search-host{min-width:0}}@media(max-width:700px){.skilled-global-results{position:fixed;left:12px;right:12px;top:66px;max-height:65vh}.skilled-search-type{display:none}header .skilled-profile-name,header .skilled-profile-role{max-width:95px}.skilled-mobile-sidebar-toggle{width:34px;height:34px;margin-right:8px}}
        `;
        style.textContent += `
...
header.skilled-app-header{min-height:calc(56px + env(safe-area-inset-top))!important;height:calc(56px + env(safe-area-inset-top))!important;padding:env(safe-area-inset-top) 10px 0!important;gap:8px!important;overflow:visible!important}
...
`;
    ...
    function syncMobileSidebarGeometry(){
        const root=document.documentElement;
        if(!window.matchMedia('(max-width:1023px)').matches){
            root.style.removeProperty('--skilled-mobile-sidebar-top');
            return;
        }
        const header=document.querySelector('header.skilled-app-header, body > div header, header');
        let top=56;
        if(header){
            const rect=header.getBoundingClientRect();
            const height=Math.max(0,Math.round(rect.height||header.offsetHeight||56));
            const viewportTop=Math.max(0,Math.round(rect.top));
            top=Math.max(48,viewportTop+height);
        }
        root.style.setProperty('--skilled-mobile-sidebar-top',`${top}px`);
    }

    function bindMobileSidebarGeometry(){
        syncMobileSidebarGeometry();
        if(document.documentElement.dataset.skilledMobileSidebarGeometryBound==='1')return;
        document.documentElement.dataset.skilledMobileSidebarGeometryBound='1';
        let timer=0;
        const schedule=()=>{clearTimeout(timer);timer=setTimeout(syncMobileSidebarGeometry,40)};
        ...
        if(header&&'ResizeObserver'in window){
            ...
            window.__skilledMobileHeaderResizeObserver=observer;
        }
    }

    function setMobileSidebarOpen(open){
        const state=Boolean(open);
        document.body.classList.toggle('skilled-mobile-sidebar-open',state);
        document.querySelectorAll('[data-sidebar-mobile-toggle]').forEach(button=>button.setAttribute('aria-expanded',state?'true':'false'));
        if(state){
            syncMobileSidebarGeometry();
            const scroll=document.querySelector('#skilled-sidebar .lista-scroll');
    ...
    function ensureMobileDock() {
        ...
        if (!dock) {
            ...
            menu.addEventListener('click', () => setMobileSidebarOpen(true));
    ...
    async function openSkyFromUi(question='') {
        ...
        try{
            if(!window.SkilledSky)await loadOptionalScript('skilled-sky.js?v=149');
    ...
    function createLazyChatButton() {
        ...
        button.addEventListener('click', async () => {
            ...
            syncMobileDock();
            try {
                await loadOptionalScript('skilled-chat.js?v=149');
    ...
    function scheduleChatNotifications() {
        ...
        const load = async () => {
            ...
            try { await loadOptionalScript('skilled-chat.js?v=149'); } catch (_) { createLazyChatButton(); }
            syncMobileDock();
        };
