...
const keys=['primary','primaryBright','accent','background','surface','surface2','border','text','muted','sidebarBackground','sidebarSurface','sidebarText','sidebarMuted','sidebarActive','sidebarActiveText','topbarBackground','topbarBorder','buttonPrimary','buttonPrimaryText','buttonSecondary','buttonSecondaryText','success','warning','danger'];
...
function setCss(pref){
 ...
 '--crm-user-sidebar-bg':pref.sidebarBackground,'--crm-user-sidebar-surface':pref.sidebarSurface,'--crm-user-sidebar-text':pref.sidebarText,'--crm-user-sidebar-muted':pref.sidebarMuted,'--crm-user-sidebar-active':pref.sidebarActive,'--crm-user-sidebar-active-text':pref.sidebarActiveText,
