    ...
    async function printQrBatch(items){
        ...
        doc.write(`<!doctype html><html><head><meta charset="utf-8"><title>Etiquetas de ubicaciones</title><style>
            *{box-sizing:border-box}html,body{margin:0;padding:0;background:#fff;font-family:Arial,sans-serif;color:#102a43;-webkit-print-color-adjust:exact;print-color-adjust:exact}
            ...
            .label{position:absolute;left:35.45mm;top:calc(9.7mm + (var(--slot) * 52mm));width:145mm;height:50mm;overflow:hidden;border:.45mm solid #00416b;background:#fff;padding:2mm 2.4mm;display:grid;grid-template-columns:31mm minmax(0,1fr);gap:1.6mm;break-inside:avoid;page-break-inside:avoid}
            .side{display:flex;flex-direction:column;align-items:center;gap:.45mm;padding-right:1.5mm;border-right:.45mm solid #00416b;min-width:0}.logo{width:26mm;max-height:6.2mm;object-fit:contain}.kicker{font-size:4.7pt;color:#00416b;letter-spacing:.09em;line-height:1.05;text-align:center}.side h1{font-size:13.5pt;line-height:1;margin:.2mm 0 0;font-weight:900}.side-note{font-size:5.5pt;color:#5f7389;margin:0}.qr{margin-top:auto;display:flex;align-items:center;justify-content:center}.qr img{width:23.5mm;height:23.5mm;display:block}
            .info{min-width:0;display:flex;flex-direction:column}.meta-row{display:flex;align-items:flex-start;justify-content:space-between;gap:1.2mm;border-bottom:.4mm solid #00416b;padding-bottom:.7mm}.meta{font-size:5.9pt;line-height:1.18;color:#32506a;margin:0;font-weight:700;min-width:0}.count{font-size:5.7pt;color:#00416b;white-space:nowrap}.materials{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));grid-auto-rows:minmax(0,1fr);gap:.55mm 1.4mm;margin-top:.8mm;min-height:0;flex:1}.material{display:flex;flex-direction:column;justify-content:flex-start;min-width:0;padding:.3mm .45mm .35mm;border-bottom:.15mm solid #dbe3ec;background:#fff;overflow:hidden}.material b{font:700 5.45pt/1.05 monospace;color:#00416b;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;display:block}.material span{display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:2;overflow:hidden;white-space:normal;overflow-wrap:anywhere;font-size:6.25pt;line-height:1.08;color:#102a43;margin-top:.25mm}.empty{grid-column:1/-1;font-size:6.5pt;color:#6b7280;margin-top:2mm}
