...
(function () {
    ...
    if (modal) {
        ...
        if (subtitle) subtitle.textContent = 'Se dará de alta en el catálogo como material incompleto. Para despacharlo debe existir stock en la bodega de origen.';
    ...
    window.agregarMaterialNoListadoEntrega = async function () {
        ...
        try {
            await SkilledDB.createIncompleteMaterial({ codigo: code, descripcion: description, categoria: category, unidad: unit, precio: price, origen: 'entrega_directa' });
