...
/* V162 · frontal/trasera más detallados y mejor escala */
function frontRearPickup(vehicle,id,rear=false){
 const x=138, top=118, bottom=386, w=524;
 if(rear){
  return `<g filter="url(#${id}-shadow)">${ground(424,300)}
   <path class="v153-body" fill="url(#${id}-body)" d="M${x+30} ${bottom}L${x+50} ${top+110}Q${x+60} ${top+24} ${x+146} ${top}H${x+w-146}Q${x+w-60} ${top+24} ${x+w-50} ${top+110}L${x+w-30} ${bottom}Z"/>
   <path class="v153-body-inset" fill="url(#${id}-body2)" d="M${x+56} ${bottom-12}L${x+70} ${top+123}Q${x+82} ${top+48} ${x+160} ${top+28}H${x+w-160}Q${x+w-82} ${top+48} ${x+w-70} ${top+123}L${x+w-56} ${bottom-12}Z"/>
   <path class="v153-glass" fill="url(#${id}-glass)" d="M${x+156} ${top+34}H${x+w-156}L${x+w-126} ${top+120}H${x+126}Z"/>
   <path class="v153-glass-line" d="M400 ${top+34}V${top+120}M${x+262} ${top+34}V${top+120}M${x+w-262} ${top+34}V${top+120}"/>
   <path class="v153-tailgate" d="M${x+88} ${top+164}H${x+w-88}V${bottom-30}H${x+88}Z"/>
   <path class="v153-tailgate-line" d="M400 ${top+164}V${bottom-32}M${x+112} ${top+196}H${x+w-112}M${x+132} ${top+223}H${x+w-132}"/>
   <path class="v153-bed-rib" d="M${x+138} ${top+176}V${bottom-31}M${x+188} ${top+176}V${bottom-31}M${x+w-188} ${top+176}V${bottom-31}M${x+w-138} ${top+176}V${bottom-31}"/>
   <path class="v153-tail-cluster" d="M${x+48} ${bottom-122}H${x+112}Q${x+126} ${bottom-122} ${x+126} ${bottom-108}V${bottom-58}Q${x+126} ${bottom-44} ${x+112} ${bottom-44}H${x+48}Z" fill="url(#${id}-tail)"/>
   <path class="v153-tail-cluster" d="M${x+w-48} ${bottom-122}H${x+w-112}Q${x+w-126} ${bottom-122} ${x+w-126} ${bottom-108}V${bottom-58}Q${x+w-126} ${bottom-44} ${x+w-112} ${bottom-44}H${x+w-48}Z" fill="url(#${id}-tail)"/>
   <path class="v153-tail-segment" d="M${x+58} ${bottom-100}H${x+113}M${x+58} ${bottom-82}H${x+113}M${x+w-113} ${bottom-100}H${x+w-58}M${x+w-113} ${bottom-82}H${x+w-58}"/>
   <rect class="v153-rear-bumper" x="${x+112}" y="${bottom-31}" width="${w-224}" height="24" rx="9"/>
   <path class="v153-grille-line" d="M${x+145} ${bottom-16}H${x+w-145}"/>
   ${plate(vehicle,362,bottom-80,76,22)}
   <rect class="v153-front-wheel" x="${x+6}" y="${bottom-10}" width="94" height="36" rx="14"/>
   <rect class="v153-front-wheel" x="${x+w-100}" y="${bottom-10}" width="94" height="36" rx="14"/>
  </g>`;
 }
 return `<g filter="url(#${id}-shadow)">${ground(424,300)}
  <path class="v153-body" fill="url(#${id}-body)" d="M${x+30} ${bottom}L${x+50} ${top+112}Q${x+64} ${top+28} ${x+150} ${top}H${x+w-150}Q${x+w-64} ${top+28} ${x+w-50} ${top+112}L${x+w-30} ${bottom}Z"/>
  <path class="v153-body-inset" fill="url(#${id}-body2)" d="M${x+58} ${bottom-12}L${x+73} ${top+124}Q${x+85} ${top+50} ${x+164} ${top+28}H${x+w-164}Q${x+w-85} ${top+50} ${x+w-73} ${top+124}L${x+w-58} ${bottom-12}Z"/>
  <path class="v153-glass" fill="url(#${id}-glass)" d="M${x+132} ${top+26}H${x+w-132}L${x+w-96} ${top+146}H${x+96}Z"/>
  <path class="v153-glass-line" d="M400 ${top+26}V${top+146}M${x+252} ${top+26}V${top+146}M${x+w-252} ${top+26}V${top+146}"/>
  <path class="v153-hood-line" d="M${x+102} ${top+172}Q400 ${top+132} ${x+w-102} ${top+172}M${x+86} ${top+198}H${x+w-86}M${x+118} ${top+221}H${x+w-118}"/>
  <path class="v153-headlight" d="M${x+48} ${bottom-120}L${x+130} ${bottom-120}L${x+160} ${bottom-95}L${x+126} ${bottom-62}L${x+54} ${bottom-62}L${x+35} ${bottom-88}Z" fill="url(#${id}-lamp)" filter="url(#${id}-glow)"/>
  <path class="v153-headlight" d="M${x+w-48} ${bottom-120}L${x+w-130} ${bottom-120}L${x+w-160} ${bottom-95}L${x+w-126} ${bottom-62}L${x+w-54} ${bottom-62}L${x+w-35} ${bottom-88}Z" fill="url(#${id}-lamp)" filter="url(#${id}-glow)"/>
  <rect class="v153-grille" x="${x+126}" y="${bottom-96}" width="${w-252}" height="58" rx="12"/>
  <path class="v153-grille-line" d="M${x+144} ${bottom-80}H${x+w-144}M${x+144} ${bottom-66}H${x+w-144}M${x+144} ${bottom-52}H${x+w-144}M${x+185} ${bottom-92}V${bottom-40}M${x+w-185} ${bottom-92}V${bottom-40}"/>
  <path class="v153-rear-bumper" d="M${x+136} ${bottom-34}H${x+w-136}L${x+w-114} ${bottom-12}H${x+114}Z"/>
  <path class="v153-front-mirror" d="M${x+24} ${top+127}L${x-20} ${top+148}L${x+6} ${top+170}L${x+40} ${top+152}Z"/>
  <path class="v153-front-mirror" d="M${x+w-24} ${top+127}L${x+w+20} ${top+148}L${x+w-6} ${top+170}L${x+w-40} ${top+152}Z"/>
  <circle class="v153-fog" cx="${x+90}" cy="${bottom-54}" r="11"/>
  <circle class="v153-fog" cx="${x+w-90}" cy="${bottom-54}" r="11"/>
  ${plate(vehicle,362,bottom-74,76,22)}
  <rect class="v153-front-wheel" x="${x+6}" y="${bottom-10}" width="94" height="36" rx="14"/>
  <rect class="v153-front-wheel" x="${x+w-100}" y="${bottom-10}" width="94" height="36" rx="14"/>
 </g>`;
}
function frontRearSuv(vehicle,id,rear=false){
 const x=150, top=110, bottom=384, w=500;
 if(rear){
  return `<g filter="url(#${id}-shadow)">${ground(424,296)}
   <path class="v153-body" fill="url(#${id}-body)" d="M${x+26} ${bottom}L${x+44} ${top+108}Q${x+54} ${top+20} ${x+132} ${top}H${x+w-132}Q${x+w-54} ${top+20} ${x+w-44} ${top+108}L${x+w-26} ${bottom}Z"/>
   <path class="v153-body-inset" fill="url(#${id}-body2)" d="M${x+48} ${bottom-12}L${x+62} ${top+120}Q${x+74} ${top+44} ${x+145} ${top+24}H${x+w-145}Q${x+w-74} ${top+44} ${x+w-62} ${top+120}L${x+w-48} ${bottom-12}Z"/>
   <path class="v153-glass" fill="url(#${id}-glass)" d="M${x+120} ${top+30}H${x+w-120}L${x+w-92} ${top+142}H${x+92}Z"/>
   <path class="v153-glass-line" d="M400 ${top+30}V${top+142}"/>
   <path class="v153-tailgate" d="M${x+78} ${top+170}H${x+w-78}V${bottom-28}H${x+78}Z"/>
   <path class="v153-tailgate-line" d="M400 ${top+170}V${bottom-32}M${x+96} ${top+202}H${x+w-96}M${x+118} ${top+227}H${x+w-118}"/>
   <path class="v153-tail-cluster" d="M${x+42} ${bottom-118}H${x+108}Q${x+122} ${bottom-118} ${x+122} ${bottom-104}V${bottom-52}Q${x+122} ${bottom-40} ${x+108} ${bottom-40}H${x+42}Q${x+20} ${bottom-76} ${x+42} ${bottom-118}Z" fill="url(#${id}-tail)"/>
   <path class="v153-tail-cluster" d="M${x+w-42} ${bottom-118}H${x+w-108}Q${x+w-122} ${bottom-118} ${x+w-122} ${bottom-104}V${bottom-52}Q${x+w-122} ${bottom-40} ${x+w-108} ${bottom-40}H${x+w-42}Q${x+w-20} ${bottom-76} ${x+w-42} ${bottom-118}Z" fill="url(#${id}-tail)"/>
   <rect class="v153-rear-bumper" x="${x+92}" y="${bottom-31}" width="${w-184}" height="24" rx="9"/>
   ${plate(vehicle,362,bottom-80,76,22)}
   <rect class="v153-front-wheel" x="${x+6}" y="${bottom-10}" width="86" height="36" rx="14"/>
   <rect class="v153-front-wheel" x="${x+w-92}" y="${bottom-10}" width="86" height="36" rx="14"/>
  </g>`;
 }
 return `<g filter="url(#${id}-shadow)">${ground(424,296)}
  <path class="v153-body" fill="url(#${id}-body)" d="M${x+26} ${bottom}L${x+44} ${top+108}Q${x+54} ${top+20} ${x+132} ${top}H${x+w-132}Q${x+w-54} ${top+20} ${x+w-44} ${top+108}L${x+w-26} ${bottom}Z"/>
  <path class="v153-body-inset" fill="url(#${id}-body2)" d="M${x+48} ${bottom-12}L${x+62} ${top+120}Q${x+74} ${top+44} ${x+145} ${top+24}H${x+w-145}Q${x+w-74} ${top+44} ${x+w-62} ${top+120}L${x+w-48} ${bottom-12}Z"/>
  <path class="v153-glass" fill="url(#${id}-glass)" d="M${x+114} ${top+24}H${x+w-114}L${x+w-88} ${top+148}H${x+88}Z"/>
  <path class="v153-glass-line" d="M400 ${top+24}V${top+148}"/>
  <path class="v153-hood-line" d="M${x+92} ${top+176}Q400 ${top+138} ${x+w-92} ${top+176}M${x+82} ${top+204}H${x+w-82}"/>
  <path class="v153-headlight" d="M${x+48} ${bottom-118}L${x+134} ${bottom-118}L${x+160} ${bottom-92}L${x+126} ${bottom-66}L${x+52} ${bottom-66}L${x+34} ${bottom-92}Z" fill="url(#${id}-lamp)" filter="url(#${id}-glow)"/>
  <path class="v153-headlight" d="M${x+w-48} ${bottom-118}L${x+w-134} ${bottom-118}L${x+w-160} ${bottom-92}L${x+w-126} ${bottom-66}L${x+w-52} ${bottom-66}L${x+w-34} ${bottom-92}Z" fill="url(#${id}-lamp)" filter="url(#${id}-glow)"/>
  <rect class="v153-grille" x="${x+124}" y="${bottom-92}" width="${w-248}" height="52" rx="13"/>
  <path class="v153-grille-line" d="M${x+140} ${bottom-76}H${x+w-140}M${x+140} ${bottom-62}H${x+w-140}M${x+182} ${bottom-92}V${bottom-40}M${x+w-182} ${bottom-92}V${bottom-40}"/>
  <path class="v153-front-mirror" d="M${x+28} ${top+124}L${x-12} ${top+144}L${x+6} ${top+168}L${x+38} ${top+150}Z"/>
  <path class="v153-front-mirror" d="M${x+w-28} ${top+124}L${x+w+12} ${top+144}L${x+w-6} ${top+168}L${x+w-38} ${top+150}Z"/>
  <circle class="v153-fog" cx="${x+86}" cy="${bottom-54}" r="11"/>
  <circle class="v153-fog" cx="${x+w-86}" cy="${bottom-54}" r="11"/>
  ${plate(vehicle,362,bottom-74,76,22)}
  <rect class="v153-front-wheel" x="${x+6}" y="${bottom-10}" width="86" height="36" rx="14"/>
  <rect class="v153-front-wheel" x="${x+w-92}" y="${bottom-10}" width="86" height="36" rx="14"/>
 </g>`;
...
function frontRearVan(vehicle,id,rear=false){
 const x=142, top=84, bottom=388, w=516;
 if(rear){
  return `<g filter="url(#${id}-shadow)">${ground(424,302)}
   <path class="v153-body" fill="url(#${id}-body)" d="M${x+18} ${bottom}L${x+36} ${top+138}Q${x+44} ${top+18} ${x+126} ${top}H${x+w-126}Q${x+w-44} ${top+18} ${x+w-36} ${top+138}L${x+w-18} ${bottom}Z"/>
   <path class="v153-body-inset" fill="url(#${id}-body2)" d="M${x+42} ${bottom-13}L${x+56} ${top+144}Q${x+64} ${top+44} ${x+140} ${top+24}H${x+w-140}Q${x+w-64} ${top+44} ${x+w-56} ${top+144}L${x+w-42} ${bottom-13}Z"/>
   <path class="v153-glass" fill="url(#${id}-glass)" d="M${x+112} ${top+34}H${x+w-112}V${top+170}H${x+112}Z"/>
   <path class="v153-glass-line" d="M400 ${top+34}V${top+170}M${x+220} ${top+34}V${top+170}M${x+w-220} ${top+34}V${top+170}"/>
   <path class="v153-tailgate" d="M${x+82} ${top+186}H${x+w-82}V${bottom-28}H${x+82}Z"/>
   <path class="v153-tailgate-line" d="M400 ${top+186}V${bottom-30}M${x+120} ${top+216}H${x+w-120}"/>
   <path class="v153-tail-cluster" d="M${x+48} ${bottom-138}H${x+110}V${bottom-54}H${x+48}Q${x+26} ${bottom-96} ${x+48} ${bottom-138}Z" fill="url(#${id}-tail)"/>
   <path class="v153-tail-cluster" d="M${x+w-48} ${bottom-138}H${x+w-110}V${bottom-54}H${x+w-48}Q${x+w-26} ${bottom-96} ${x+w-48} ${bottom-138}Z" fill="url(#${id}-tail)"/>
   <rect class="v153-rear-bumper" x="${x+98}" y="${bottom-31}" width="${w-196}" height="24" rx="8"/>
   ${plate(vehicle,362,bottom-80,76,22)}
   <rect class="v153-front-wheel" x="${x+4}" y="${bottom-10}" width="92" height="36" rx="14"/>
   <rect class="v153-front-wheel" x="${x+w-96}" y="${bottom-10}" width="92" height="36" rx="14"/>
  </g>`;
 }
 return `<g filter="url(#${id}-shadow)">${ground(424,302)}
  <path class="v153-body" fill="url(#${id}-body)" d="M${x+18} ${bottom}L${x+36} ${top+138}Q${x+44} ${top+18} ${x+126} ${top}H${x+w-126}Q${x+w-44} ${top+18} ${x+w-36} ${top+138}L${x+w-18} ${bottom}Z"/>
  <path class="v153-body-inset" fill="url(#${id}-body2)" d="M${x+42} ${bottom-13}L${x+56} ${top+144}Q${x+64} ${top+44} ${x+140} ${top+24}H${x+w-140}Q${x+w-64} ${top+44} ${x+w-56} ${top+144}L${x+w-42} ${bottom-13}Z"/>
  <path class="v153-glass" fill="url(#${id}-glass)" d="M${x+104} ${top+26}H${x+w-104}L${x+w-78} ${top+158}H${x+78}Z"/>
  <path class="v153-glass-line" d="M400 ${top+26}V${top+158}M${x+248} ${top+26}V${top+158}M${x+w-248} ${top+26}V${top+158}"/>
  <path class="v153-hood-line" d="M${x+96} ${top+190}Q400 ${top+150} ${x+w-96} ${top+190}M${x+84} ${top+219}H${x+w-84}"/>
  <path class="v153-headlight" d="M${x+42} ${bottom-126}L${x+122} ${bottom-126}L${x+146} ${bottom-102}L${x+122} ${bottom-68}L${x+46} ${bottom-68}L${x+28} ${bottom-98}Z" fill="url(#${id}-lamp)" filter="url(#${id}-glow)"/>
  <path class="v153-headlight" d="M${x+w-42} ${bottom-126}L${x+w-122} ${bottom-126}L${x+w-146} ${bottom-102}L${x+w-122} ${bottom-68}L${x+w-46} ${bottom-68}L${x+w-28} ${bottom-98}Z" fill="url(#${id}-lamp)" filter="url(#${id}-glow)"/>
  <rect class="v153-grille" x="${x+118}" y="${bottom-94}" width="${w-236}" height="48" rx="12"/>
  <path class="v153-grille-line" d="M${x+138} ${bottom-79}H${x+w-138}M${x+138} ${bottom-64}H${x+w-138}M${x+138} ${bottom-50}H${x+w-138}"/>
  <path class="v153-front-mirror" d="M${x+22} ${top+146}L${x-18} ${top+166}L${x+6} ${top+188}L${x+38} ${top+172}Z"/>
  <path class="v153-front-mirror" d="M${x+w-22} ${top+146}L${x+w+18} ${top+166}L${x+w-6} ${top+188}L${x+w-38} ${top+172}Z"/>
  <circle class="v153-fog" cx="${x+86}" cy="${bottom-54}" r="11"/>
  <circle class="v153-fog" cx="${x+w-86}" cy="${bottom-54}" r="11"/>
  ${plate(vehicle,362,bottom-72,76,22)}
  <rect class="v153-front-wheel" x="${x+4}" y="${bottom-10}" width="92" height="36" rx="14"/>
  <rect class="v153-front-wheel" x="${x+w-96}" y="${bottom-10}" width="92" height="36" rx="14"/>
 </g>`;
}
function frontRearTruck(vehicle,id,rear=false){
 const x=132, top=78, bottom=390, w=536;
 if(rear){
  return `<g filter="url(#${id}-shadow)">${ground(424,306)}
   <path class="v153-body" fill="url(#${id}-body)" d="M${x+16} ${bottom}L${x+34} ${top+146}Q${x+42} ${top+16} ${x+128} ${top}H${x+w-128}Q${x+w-42} ${top+16} ${x+w-34} ${top+146}L${x+w-16} ${bottom}Z"/>
   <path class="v153-body-inset" fill="url(#${id}-body2)" d="M${x+40} ${bottom-13}L${x+54} ${top+152}Q${x+62} ${top+42} ${x+143} ${top+22}H${x+w-143}Q${x+w-62} ${top+42} ${x+w-54} ${top+152}L${x+w-40} ${bottom-13}Z"/>
   <path class="v153-truckbox" fill="url(#${id}-body3)" d="M${x+62} ${top+182}H${x+w-62}V${bottom-27}H${x+62}Z"/>
   <path class="v153-bed-rib" d="M${x+110} ${top+182}V${bottom-27}M${x+162} ${top+182}V${bottom-27}M${x+214} ${top+182}V${bottom-27}M${x+266} ${top+182}V${bottom-27}M${x+w-214} ${top+182}V${bottom-27}M${x+w-162} ${top+182}V${bottom-27}M${x+w-110} ${top+182}V${bottom-27}M${x+62} ${top+214}H${x+w-62}"/>
   <path class="v153-glass" fill="url(#${id}-glass)" d="M${x+150} ${top+34}H${x+w-150}L${x+w-122} ${top+136}H${x+122}Z"/>
   <path class="v153-glass-line" d="M400 ${top+34}V${top+136}"/>
   <rect class="v153-tail-cluster" x="${x+66}" y="${bottom-130}" width="64" height="74" rx="10" fill="url(#${id}-tail)"/>
   <rect class="v153-tail-cluster" x="${x+w-130}" y="${bottom-130}" width="64" height="74" rx="10" fill="url(#${id}-tail)"/>
   <rect class="v153-rear-bumper" x="${x+110}" y="${bottom-30}" width="${w-220}" height="23" rx="8"/>
   ${plate(vehicle,362,bottom-79,76,22)}
   <rect class="v153-front-wheel" x="${x+2}" y="${bottom-10}" width="96" height="36" rx="14"/>
   <rect class="v153-front-wheel" x="${x+w-98}" y="${bottom-10}" width="96" height="36" rx="14"/>
  </g>`;
 }
 return `<g filter="url(#${id}-shadow)">${ground(424,306)}
  <path class="v153-body" fill="url(#${id}-body)" d="M${x+16} ${bottom}L${x+34} ${top+146}Q${x+42} ${top+16} ${x+128} ${top}H${x+w-128}Q${x+w-42} ${top+16} ${x+w-34} ${top+146}L${x+w-16} ${bottom}Z"/>
  <path class="v153-body-inset" fill="url(#${id}-body2)" d="M${x+40} ${bottom-13}L${x+54} ${top+152}Q${x+62} ${top+42} ${x+143} ${top+22}H${x+w-143}Q${x+w-62} ${top+42} ${x+w-54} ${top+152}L${x+w-40} ${bottom-13}Z"/>
  <path class="v153-glass" fill="url(#${id}-glass)" d="M${x+128} ${top+26}H${x+w-128}L${x+w-96} ${top+154}H${x+96}Z"/>
  <path class="v153-glass-line" d="M400 ${top+26}V${top+154}"/>
  <path class="v153-hood-line" d="M${x+98} ${top+194}Q400 ${top+152} ${x+w-98} ${top+194}M${x+86} ${top+222}H${x+w-86}"/>
  <path class="v153-headlight" d="M${x+44} ${bottom-128}L${x+140} ${bottom-128}L${x+170} ${bottom-98}L${x+138} ${bottom-66}L${x+48} ${bottom-66}L${x+30} ${bottom-100}Z" fill="url(#${id}-lamp)" filter="url(#${id}-glow)"/>
  <path class="v153-headlight" d="M${x+w-44} ${bottom-128}L${x+w-140} ${bottom-128}L${x+w-170} ${bottom-98}L${x+w-138} ${bottom-66}L${x+w-48} ${bottom-66}L${x+w-30} ${bottom-100}Z" fill="url(#${id}-lamp)" filter="url(#${id}-glow)"/>
  <rect class="v153-grille" x="${x+124}" y="${bottom-98}" width="${w-248}" height="56" rx="12"/>
  <path class="v153-grille-line" d="M${x+146} ${bottom-82}H${x+w-146}M${x+146} ${bottom-68}H${x+w-146}M${x+146} ${bottom-54}H${x+w-146}M${x+184} ${bottom-92}V${bottom-44}M${x+w-184} ${bottom-92}V${bottom-44}"/>
  <path class="v153-front-mirror" d="M${x+18} ${top+154}L${x-26} ${top+176}L${x+2} ${top+198}L${x+40} ${top+180}Z"/>
  <path class="v153-front-mirror" d="M${x+w-18} ${top+154}L${x+w+26} ${top+176}L${x+w-2} ${top+198}L${x+w-40} ${top+180}Z"/>
  <circle class="v153-fog" cx="${x+94}" cy="${bottom-55}" r="11"/>
  <circle class="v153-fog" cx="${x+w-94}" cy="${bottom-55}" r="11"/>
  ${plate(vehicle,362,bottom-73,76,22)}
  <rect class="v153-front-wheel" x="${x+2}" y="${bottom-10}" width="96" height="36" rx="14"/>
  <rect class="v153-front-wheel" x="${x+w-98}" y="${bottom-10}" width="96" height="36" rx="14"/>
 </g>`;
}
function render(vehicle,view='superior',options={}){
 const shape=shapeKey(vehicle),safe=['superior','frontal','lado_izquierdo','lado_derecho','trasera'].includes(view)?view:'superior';
 if(safe==='superior')return topVisual(vehicle,options);
 const id=`v162-${shape}-${safe}-${++vehicleSvgSequence}`;
 const content=safe==='frontal'?genericFrontRear(vehicle,shape,id,false):safe==='trasera'?genericFrontRear(vehicle,shape,id,true):safe==='lado_derecho'?genericSide(vehicle,shape,id,true):genericSide(vehicle,shape,id,false);
 const classes=['vehicle-visual-v153','vehicle-visual-v152','vehicle-visual-v149','vehicle-silhouette',options.compact?'is-compact':''].filter(Boolean).join(' ');
 let viewBox;
 if(safe==='frontal'||safe==='trasera'){
   if(options.compact){
     viewBox=shape==='truck'?'104 72 592 332':shape==='van'?'110 76 580 326':shape==='pickup'?'116 82 568 320':shape==='suv'?'116 82 568 320':'130 95 540 296';
   }else{
     viewBox=shape==='truck'?'118 76 564 326':shape==='van'?'122 78 556 324':shape==='pickup'?'126 88 548 314':shape==='suv'?'126 88 548 314':'140 102 520 290';
   }
 }else{
   viewBox=options.compact?(shape==='pickup'?'70 126 660 224':shape==='truck'?'54 122 692 228':shape==='suv'?'64 124 674 224':shape==='van'?'54 122 692 228':shape==='car'?'82 128 644 218':'60 118 680 244'):'35 70 730 365';
 }
 return `<svg class="${classes}" viewBox="${viewBox}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${esc(labels[shape])} · ${esc(safe)}">${viewDefs(id,shape)}${content}</svg>`
}
window.NexusVehicleVisuals={render,type:shapeKey,label:v=>labels[shapeKey(v)]||'Vehículo',version:'162'};
})();
